...
if __name__ == "__main__":
    ...
    partial_evals = {"Material": "mat_only", "Mobility": "mob_only", "Pawn Structure": "ps_only", "King Security": "ks_only", "Bishop Pair + Rook Open File + PS-Tables": "other_only"}
    all_means = [np.around(get_run_times(data, run), decimals=0).mean() for run in partial_evals.values()]
