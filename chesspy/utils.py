...
get_char_to_int_board_state = lambda char: board_state_char_to_int_map.get(char, -1)
board_state_int_to_char_map = lambda int: board_state_int_to_char_map.get(int, ' ')
